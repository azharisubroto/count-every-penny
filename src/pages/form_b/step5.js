...
export default function form2Step5(props) {
          ...
          <Box pt={{ xs: 2, sm: 3, md: 3 }}>
            <div className="form_b_card">
              <Box pt={{ xs: 2, sm: 3, md: 4 }} px={{ xs: 2, sm: 3, md: 3 }}>
                ...
                {/* Headling */}
                <Box mt={3}>
                  <div className="lookingfor text-20 lh-25 text-md-32 lh-md-40">Tell us about yourself</div>
                </Box>
                ...
                <Box maxWidth="740px" mx="auto" justifyContent="center" display="flex">
                  <Link href="/form_b/step6">
                    <Button className={classes.submitbutton}>Find Quotes</Button>
                  </Link>
                </Box>
